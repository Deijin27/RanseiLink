...
public class WarriorSkillViewModel : ViewModelBase
{
    ...
    public int Effect1Amount
    {
        ...
        set => Set(_model.Effect1Amount, value, v => _model.Effect1Amount = v);
    }
    ...
    public int Effect2Amount
    {
        ...
        set => Set(_model.Effect2Amount, value, v => _model.Effect2Amount = v);
    }
    ...
    public int Effect3Amount
    {
        ...
        set => Set(_model.Effect3Amount, value, v => _model.Effect3Amount = v);
    }

    public int Duration
    {
        get => _model.Duration;
        set => Set(_model.Duration, value, v => _model.Duration = v);
    }

    public WarriorSkillTargetId Target
    {
        get => _model.Target;
        set => Set(_model.Target, value, v => _model.Target = v);
    }

    public MoveAnimationId Animation
    {
        get => _model.Animation;
        set => Set(_model.Animation, value, v => _model.Animation = v);
    }
