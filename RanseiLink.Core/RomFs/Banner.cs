...
namespace RanseiLink.Core.RomFs
{
    ...
    public class Banner : BannerInfo
    {
        ...
        public Banner(BinaryReader br)
        {
            ...
            ImagePalette = RawPalette.Decompress(br.ReadBytes(0x20));
    ...
    public static class BannerExtensions
    {
        ...
        public static bool TryLoadInfoFromXml(this BannerInfo banner, string file, out string failureReason)
        {
            try
            {
        ...
        public static void SaveImageToPng(this Banner banner, string file)
        {
            ...
            ImageUtil.SaveAsPng(file, imageInfo, tiled: true);
        }

        public static bool TryLoadImageFromPng(this Banner banner, string file, out string failureReason)
        {
            var imageInfo = ImageUtil.LoadPng(file, true);
