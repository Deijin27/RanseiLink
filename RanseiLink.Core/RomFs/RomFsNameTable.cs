...
public static class RomFsNameTable
{
    public class FolderAllocation
    {
        ...
        public FolderAllocation(BinaryReader br)
        {
            Offset = br.ReadInt32();
            FatTopFileId = br.ReadUInt16();
            FolderIndex = new FolderIndex(br.ReadUInt16());
        }

        public int Offset { get; }
        public ushort FatTopFileId { get; }
        public FolderIndex FolderIndex { get; }
    }
    ...
    public class FileOrFolderName
    {
        ...
        public FolderIndex ContentsIndexIfFolder { get; }

        public FileOrFolderName(bool isFolder, byte[] name, FolderIndex contentsIndexIfFolder)
        {
            IsFolder = isFolder;
            Name = name;
            ContentsIndexIfFolder = contentsIndexIfFolder;
        }
    }
    ...
    public static FolderAllocation GetAllocationData(BinaryReader stream, long startOffset, FolderIndex folderIndex)
    {
        ...
        return new FolderAllocation(stream);
    }
    ...
    public static List<FileOrFolderName> GetContents(BinaryReader stream, long startOffset, FolderAllocation alloc)
    {
        ...
        while (nameHeader.Length.ToInt32() != 0)
        {
            var name = new FileOrFolderName(
                ...
                contentsIndexIfFolder: nameHeader.IsFolder ? new FolderIndex(stream.ReadUInt16()) : default
                );
    ...
    public static uint GetFatEntryIndex(BinaryReader stream, long startOffset, string filePath)
    {
        ...
        {
            throw new Exception($"Could not get directory from file path '{filePath}'");
        }
