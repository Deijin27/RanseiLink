...
public class NcgrTests
{
    ...
    public void LoadNcgrScreen()
    {
        ...
        chr.Data[..0x10].Should().Equal([0xFB, 0xFA, 0xFC, 0xFB, 0xFC, 0xFA, 0xFC, 0xFA, 0xFB, 0xFC, 0xFA, 0xFC, 0xFA, 0xFC, 0xFA, 0xFC]);
    }
    ...
    public void LoadNcgrParts()
    {
        ...
        chr.Data.Skip(0x1870).Take(0x10).ToArray().Should().Equal([0xB1, 0xB4, 0xBB, 0xD0, 0xC8, 0xC8, 0xE9, 0xF0, 0xF9, 0xF2, 0xF0, 0xF1, 0xEF, 0xEF, 0xEA, 0xEF]);
    }
    ...
    [InlineData("test_inst_powerplant.ncgr")]
